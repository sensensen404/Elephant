package org.idaxiang.elephant.support.lib.sinasso;
...
public class SsoHandler {
        ...
        conn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    AppLogger.e(ssoActivityName + " " + ssoPackageName);
    ...
    private boolean bindRemoteSSOService(Activity activity) {
        ...
        Intent intent = new Intent("com.sina.weibo.remotessoservice").setPackage("com.sina.weibo");
    ...
    private boolean startSingleSignOn(Activity activity, String[] permissions, int activityCode) {
        ...
        intent.putExtra("appKey", Constants.SINA_APP_KEY);
        intent.putExtra("redirectUri", Constants.DIRECT_URL);
