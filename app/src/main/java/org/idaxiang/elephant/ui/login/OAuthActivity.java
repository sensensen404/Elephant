...
public class OAuthActivity extends ToolbarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_actionbar_oauth, menu);
...
//                startActivity(intent);
    ...
    private String getWeiboOAuthUrl() {
        ...
        parameters.put("redirect_uri", Constants.DIRECT_URL);
        parameters.put("display", "mobile");
        parameters.put("packagename", OAuthActivity.this.getPackageName());
        parameters.put("key_hash", Utility.getSign(OAuthActivity.this, OAuthActivity.this.getPackageName()));

        String url = "https://open.weibo.cn/oauth2/authorize?" + Utility.encodeUrl(parameters);
        return url;
//        return Constants.URL_OAUTH2_ACCESS_AUTHORIZE + "?" + Utility.encodeUrl(parameters)
//                + "&scope=friendships_groups_read,friendships_groups_write";
    ...
    private static class OAuthTask extends MyAsyncTask<String, UserModel, DBResult> {
...
//            try {
            ...
            return DBResult.add_successfuly;
//            }
